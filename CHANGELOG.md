...
- Added new settings for `Reading Stats` including a new setting for `Idle time threshold` that caps time-left pace samples and discards reading time stat for that page.
